...
import { BG_URL, USE_AVATAR } from "../utility/constants";
  ...
  return (
    <div className="">
      ...
      <form
        ...
        className=" absolute w-full md:w-3/12 p-12 my-36 mx-auto right-0 left-0 text-white bg-black rounded-lg bg-opacity-80"
      >
